...
Config.AdvancedFaceParts = {
	{ label = "Nasenbreite", type = "nose_width" },
	{ label = "Nasenlänge", type = "nose_peak" },
	{ label = "Nasentiefe", type = "nose_length" },
	{ label = "Nasenkurvigkeit", type = "nose_curveness" },
	{ label = "Nasenspitze", type = "nose_tip" },
	{ label = "Nasendrehung", type = "nose_twist" },
	{ label = "Augenbrauenhöhe", type = "eyebrows_height" },
	{ label = "Augenbrauentiefe", type = "eyebrows_depth" },
	{ label = "Wangenhöhe", type = "cheeks_height" },
	{ label = "Wangenbreite 1", type = "cheeks_width1" },
	{ label = "Wangenbreite 2", type = "cheeks_width2" },
	{ label = "Augenöffnung", type = "eye_opening" },
	{ label = "Lippendicke", type = "lip_thickness" },
	{ label = "Kieferbreite", type = "jaw_width" },
	{ label = "Kieferform", type = "jaw_shape" },
	{ label = "Kinnhöhe", type = "chin_height" },
	{ label = "Kinnlänge", type = "chin_length" },
	{ label = "Kinnbreite", type = "chin_width" },
	{ label = "Kinnspalte", type = "chin_hole" },
...
Config.skinContent = {
	...
	},
	{
		...
		name2 = "eyebrows_color2",
		label = "Augenbrauenfarbe",
		zoomOffset = 0.6,
		camOffset = 0.7,
		type = 3,
		amountComponents = GetNumHairColors() - 1,
	...
	{
		componentID = nil,
		name = "lipstick_color1",
		name2 = "lipstick_color2",
		label = "Lippenstiftfarbe",
		zoomOffset = 0.6,
		camOffset = 0.7,
		type = 3,
		amountComponents = GetNumHairColors() - 1,
	...
	{
		componentID = 8,
		name = "tshirt_drawable",
		name2 = "tshirt_texture",
		label = "T-Shirts",
		zoomOffset = 0.75,
		camOffset = 0.15,
		type = 1,
	...
	{
		componentID = 1,
		name = "glasses_drawable",
		name2 = "glasses_texture",
		label = "Brille",
		zoomOffset = 0.6,
		camOffset = 0.65,
		type = 2,
