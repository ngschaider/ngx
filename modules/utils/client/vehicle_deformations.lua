...
module.vehicle.GetDeformation = function(vehicle)
	...
	logger.debug("vehicle", "Got " .. tostring(#deformationPoints) .. " deformation point" .. (#deformationPoints == 1 and "" or "s") .. " from \"" .. tostring(GetVehicleNumberPlateText(vehicle)) .. "\"")
