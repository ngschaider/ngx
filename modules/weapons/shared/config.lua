...
weaponConfig = {
	...
	{name = "WEAPON_CERAMICPISTOL", label = _U("weapon_ceramicpistol"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_rounds"), hash = GetHashKey("AMMO_PISTOL")}},
	{
	...
	{name = "WEAPON_DOUBLEACTION", label = _U("weapon_doubleaction"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_rounds"), hash = GetHashKey("AMMO_PISTOL")}},
	{name = "WEAPON_NAVYREVOLVER", label = _U("weapon_navyrevolver"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_rounds"), hash = GetHashKey("AMMO_PISTOL")}},
	{name = "WEAPON_FLAREGUN", label = _U("weapon_flaregun"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_flaregun"), hash = GetHashKey("AMMO_FLAREGUN")}},
	{name = "WEAPON_GADGETPISTOL", label = _U("weapon_gadgetpistol"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_rounds"), hash = GetHashKey("AMMO_PISTOL")}},
	{
	...
	{name = "WEAPON_MARKSMANPISTOL", label = _U("weapon_marksmanpistol"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_rounds"), hash = GetHashKey("AMMO_PISTOL")}},
	{
		name = "WEAPON_PISTOL",
	...
	{name = "WEAPON_AUTOSHOTGUN", label = _U("weapon_autoshotgun"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_shells"), hash = GetHashKey("AMMO_SHOTGUN")}},
	{
	...
	{name = "WEAPON_DBSHOTGUN", label = _U("weapon_dbshotgun"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_shells"), hash = GetHashKey("AMMO_SHOTGUN")}},
	{
	...
	{name = "WEAPON_MUSKET", label = _U("weapon_musket"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_rounds"), hash = GetHashKey("AMMO_SHOTGUN")}},
	{
	...
	{name = "WEAPON_RAYCARBINE", label = _U("weapon_raycarbine"), ammo = {label = _U("ammo_rounds"), hash = GetHashKey("AMMO_SMG")}, tints = defaultWeaponTints, components = {}},
	-- Rifles
	{
	...
	-- Heavy / Launchers
	{name = "WEAPON_COMPACTLAUNCHER", label = _U("weapon_compactlauncher"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_grenadelauncher"), hash = GetHashKey("AMMO_GRENADELAUNCHER")}},
	{name = "WEAPON_FIREWORK", label = _U("weapon_firework"), components = {}, ammo = {label = _U("ammo_firework"), hash = GetHashKey("AMMO_FIREWORK")}},
	{name = "WEAPON_GRENADELAUNCHER", label = _U("weapon_grenadelauncher"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_grenadelauncher"), hash = GetHashKey("AMMO_GRENADELAUNCHER")}},
	{name = "WEAPON_HOMINGLAUNCHER", label = _U("weapon_hominglauncher"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_rockets"), hash = GetHashKey("AMMO_HOMINGLAUNCHER")}},
	{name = "WEAPON_MINIGUN", label = _U("weapon_minigun"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_rounds"), hash = GetHashKey("AMMO_MINIGUN")}},
	{name = "WEAPON_RAILGUN", label = _U("weapon_railgun"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_rounds"), hash = GetHashKey("AMMO_RAILGUN")}},
	{name = "WEAPON_RPG", label = _U("weapon_rpg"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_rockets"), hash = GetHashKey("AMMO_RPG")}},
	{name = "WEAPON_RAYMINIGUN", label = _U("weapon_rayminigun"), tints = defaultWeaponTints, components = {}, ammo = {label = _U("ammo_rounds"), hash = GetHashKey("AMMO_MINIGUN")}},
	-- Thrown
